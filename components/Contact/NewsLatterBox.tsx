const NewsLatterBox = () => {
  return (
    ...
    >
      ...
      <p className="text-base font-medium leading-relaxed border-b border-opacity-25 mb-11 border-body-color pb-11 text-body-color dark:border-white dark:border-opacity-25">
        Recibe actualizaciones semanales sobre nuevos productos y ofertas
      </p>
      <form>
        <input
          type="text"
        ...
        <input
          type="submit"
          value="Subscribe"
          className="w-full px-6 py-3 mb-4 text-base font-medium text-center text-white transition ease-in-out border border-transparent rounded-md outline-none cursor-pointer duration-80 bg-primary hover:bg-opacity-80 hover:shadow-signUp focus-visible:shadow-none"
        />
